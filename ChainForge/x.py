...
contract_mi = w3.eth.contract(
    abi=abi, bytecode=bytecode, address="0x5d31E972202b5520bD0639B2A4F4CF38325C7FcB"
)
...
mnemonic_phrase = "pig key virtual pepper ozone casual universe august mirror eight man online"
...
def send_order():
    ...
    if form.validate_on_submit():
        ...
        transaction = contract_mi.functions.Order(
            form.title.data,
            rec_account.address,
            0,
            int(form.price.data),
